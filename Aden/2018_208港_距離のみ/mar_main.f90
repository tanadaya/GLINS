...
!      end if
!      close(112)
  500 format(3I5, F15.5, 2I3, 43F20.5, I3, 40F20.5) !一番右のFの手前の数字を船社数に、右から二番目のFの前を船社数＋3に変更する
